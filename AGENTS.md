...
| 🧑‍💼 | **Field Leads** | `team/lead/*` (frontend, backend, quality, security, platform, product, research, telegram, pinescript, mobile, web3, seo, lgtm) | Advise on orchestration for their field — recommend specialists, NEVER spawn |
| 👥 | **Staff** | 63 specialist agents | Do the work, report up through the Team Lead |

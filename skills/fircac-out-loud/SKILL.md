...
**Questions:**
- Where is the extension point — an interface, a strategy, a plugin slot?
...
**Verdict:** PASS — depends on an abstraction, injected at the composition root. **INSTANTIATES OWN DEPS** — the module constructs its own concrete dependencies.
